...
(() => {
  ...
  function renderResponseData(data, targetId, config, Alpine, trigger) {
    ...
    const transitionType = trigger && typeof trigger.getAttribute === "function" ? trigger.getAttribute("data-catchy-transition") || trigger.getAttribute("catchy-transition") || config.viewTransitions : config.viewTransitions;
