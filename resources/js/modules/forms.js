/**
 * CatchyUI  Forms Module
 *
 * Class-based XHR request wrapper and form submitter with progress tracking.
 */

export class CatchyForms {
  /**
...
export const formsInstance = new CatchyForms();
